      ...
      <div className="flex justify-around py-2">
        <button 
          ...
          className={`flex flex-col items-center py-2 px-4 rounded-lg transition-colors ${
            activeTab === 'workout' ? 'text-emerald-400' : isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-400 hover:text-gray-900'
          }`}
        >
        ...
        <div className="flex flex-col items-center py-2 px-4 text-gray-300 opacity-50 cursor-not-allowed">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
          <span className="text-xs mt-0.5">Progress</span>
          <span className="text-[8px] text-gray-400">Coming Soon</span>
        </div>
        <div className="flex flex-col items-center py-2 px-4 text-gray-300 opacity-50 cursor-not-allowed">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
